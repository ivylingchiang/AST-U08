...
# 輸出：data/samples/slimpajama_100k.jsonl, log/slim_hnsw/resource_data/Islim_read_YYYYMMDD_HHMMSS.txt

# 路徑設定
ROOT = Path("/home/u08/workspace/HNSW") #here
...
def save_resource_data(metrics):
    ...
    file_name = RESOURCE_DIR / f"Islim_read_{timestamp}.txt"
