...
# 輸出：data/samples/slimpajama_100k.jsonl, log/slim_hnsw/resource_data/Hslim_read_YYYYMMDD_HHMMSS.txt
...
# 資源量測數據的儲存路徑
RESOURCE_DIR = Path("/home/u08/workspace/HNSW/log/slim_hnsw/resource_data")
...
def save_resource_data(metrics):
    ...
    file_name = RESOURCE_DIR / f"Hslim_read_{timestamp}.txt"
